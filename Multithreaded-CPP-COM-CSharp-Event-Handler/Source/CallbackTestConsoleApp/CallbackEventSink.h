...
#import "CallbackDLL.tlb" raw_interfaces_only, raw_native_types, no_namespace, named_guids 

class CallbackEventSink;
// ***** Declare an event handling class using the TEventHandler template. *****
typedef TEventHandlerNamespace::TEventHandler<CallbackEventSink, ICallbackTest, _ICallbackTestEvents> IEventFiringObjectEventHandler;

class CallbackEventSink
{
public:
	CComPtr<ICallbackTest> CallbackTest;
